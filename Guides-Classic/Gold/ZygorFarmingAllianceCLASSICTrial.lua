...
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Small Spider Leg")
...
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Crag Boar Rib")
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Spider Ichor")
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Coyote Meat, Boar Intestines, Stringy Vulture Meat")
...
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Murloc Eye")
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Bear Meat")
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Goretusk Snout, Goretusk Liver")
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Crawler Meat, Crawler Meat")
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Clam Meat")
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Boar Ribs")
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Crocolisk Meat")
...
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Tough Condor Meat")
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Soft Frenzy Flesh")
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Raw Loch Frenzy")
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Murloc Fin")
ZygorGuidesViewer:RegisterGuidePlaceholder("GOLD\\Farming\\Lean Wolf Flank")
