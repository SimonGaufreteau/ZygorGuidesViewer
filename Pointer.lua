	...
	elseif waypoint.pathnode and (waypoint.pathnode.type=="ship" or waypoint.pathnode.type=="zeppelin") and LibRover.is_involuntary_movement then
		...
		elseif waypoint.actionicon then
			...
			if not angle_error then
				...
				ArrowFrame:ShowError()
				if ZGV.db.global.travelmode==1 then
	...
	if simpleway then
		...
		if Pointer.DestinationWaypoint then
			...
			tinsert(menu,{
				...
				checked = function() return ZGV.db.global.travelmode==1 end,
				func = function() ZGV.db.global.travelmode=1 refreshlibrover() end,
				keepShownOnClick=1,
			...
			tinsert(menu,{
				...
				checked = function() return ZGV.db.global.travelmode==2 end,
				func = function() ZGV.db.global.travelmode=2 refreshlibrover() end,
				keepShownOnClick=1,
			...
			tinsert(menu,{
				...
				checked = function() return ZGV.db.global.travelmode==3 end,
				func = function() ZGV.db.global.travelmode=3 refreshlibrover() end,
				keepShownOnClick=1,
			...
			tinsert(menu,{
				...
				checked = function() return ZGV.db.global.travelmode==4 end,
				func = function() ZGV.db.global.travelmode=4 refreshlibrover() end,
				keepShownOnClick=1,
				tooltipTitle = L['opt_travelmode_4'],
				tooltipText = L['opt_travelmode_4_desc'],
			})
			if ZGV.db.global.travelmode==4 then
				tinsert(menu,{
