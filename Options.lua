		...
		args = {
			...
			steps = {
				...
				name = function()
					...
					return L["opt_guide_steps"]:format(#ZGV.CurrentGuide.steps)
				end,
			},
			author = {
				order = 3.2,
				type = "description",
				name = function()
					if not ZGV.CurrentGuide or not ZGV.CurrentGuide.author then
						return ""
					end
					return L["opt_guide_author"]:format(ZGV.CurrentGuide.author)
				end,
			},
			next = {
				order = 3.3,
				type = "description",
				name = function()
					if not ZGV.CurrentGuide or not ZGV.CurrentGuide.next then
						return ""
					end
					return L["opt_guide_next"]:format(ZGV.CurrentGuide.next)
				end,
			},
			show = {
				name = L["opt_visible"],
	...
	self.optionsdisplay = {
		...
		args = {
			...
			guidesinhistory = {
				...
				set = function(i, v)
					Setter_Simple(i, v)
					while #self.db.char.guides_history > v do
						tremove(self.db.char.guides_history)
					end
				end,
				step = 1,
				bigStep = 1,
			...
			step = {
				...
				args = {
					...
					goalbackincomplete = {
						...
						get = function()
							return self.db.profile.goalbackincomplete.r,
								self.db.profile.goalbackincomplete.g,
								self.db.profile.goalbackincomplete.b,
								self.db.profile.goalbackincomplete.a
						end,
					...
					goalbackprogressing = {
						...
						get = function()
							return self.db.profile.goalbackprogressing.r,
								self.db.profile.goalbackprogressing.g,
								self.db.profile.goalbackprogressing.b,
								self.db.profile.goalbackprogressing.a
						end,
						set = function(_, r, g, b, a)
					...
					goalbackcomplete = {
						...
						get = function()
							return self.db.profile.goalbackcomplete.r,
								self.db.profile.goalbackcomplete.g,
								self.db.profile.goalbackcomplete.b,
								self.db.profile.goalbackcomplete.a
						end,
						set = function(_, r, g, b, a)
					...
					goalbackimpossible = {
						...
						get = function()
							return self.db.profile.goalbackimpossible.r,
								self.db.profile.goalbackimpossible.g,
								self.db.profile.goalbackimpossible.b,
								self.db.profile.goalbackimpossible.a
						end,
						set = function(_, r, g, b, a)
					...
					goalbackprogress = {
						...
						get = function()
							return self.db.profile.goalbackprogress
						end,
						set = function()
							self.db.profile.goalbackprogress = not self.db.profile.goalbackprogress
							self:UpdateFrame()
						end,
						order = 10.9,
						width = "double",
					...
					goalcompletionflash = {
						...
						disabled = function()
							return self.db.profile.goalupdateflash
						end,
						get = function()
		...
		args = {
			...
			showobsolete = {
				...
				set = function(i, v)
					Setter_Simple(i, v)
					if not v then
						self.db.profile.skipobsolete = nil
					end
					self:UpdateFrame()
				end,
				width = "full",
			...
			skipobsolete = {
				...
				get = function()
					return self.db.profile.skipobsolete and self.db.profile.showobsolete
				end,
				disabled = function()
					return not self.db.profile.showobsolete
				end,
				width = "full",
				order = 3.7,
			},
			...
			goalbackobsolete = {
				...
				get = function()
					return self.db.profile.goalbackobsolete.r,
						self.db.profile.goalbackobsolete.g,
						self.db.profile.goalbackobsolete.b,
						self.db.profile.goalbackobsolete.a
				end,
				set = function(_, r, g, b, a)
					self.db.profile.goalbackobsolete = { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a }
					self:UpdateFrame()
				end,
				order = 12.2,
				hasAlpha = true,
	...
	self.optionsmap = {
		...
		args = {
			...
			transparency = {
				...
				set = "SetIconAlpha",
				disabled = function()
					return not self:IsShowingMinimapIcons() or (self.db.profile.waypointaddon ~= "cart2")
				end,
				order = 4,
			},
			scale = {
			...
			foglightdebug = {
				...
				type = "execute",
				func = function()
					ZGV.Foglight:DebugMap()
				end,
				order = 99,
				hidden = function()
					return not self.db.profile.debug
				end,
			},
		},
	}
...
function me:Options_SetupBlizConfig()
	...
	LibStub("AceConfigDialog-3.0"):AddToBlizOptions(
		"ZygorGuidesViewer-Display",
		self.optionsdisplay.name,
		self.options.name
	)
	LibStub("AceConfigDialog-3.0"):AddToBlizOptions(
		"ZygorGuidesViewer-Progress",
		self.optionsprogress.name,
		self.options.name
	)
...
function me:SetIconScale(info, value)
	...
	if not self:IsWaypointAddonEnabled("cart2") then
		return
	end
