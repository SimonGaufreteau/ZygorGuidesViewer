...
function QuestieCompat.LoadUiMapData(expansionLevel)
	if (expansionLevel or QuestieCompat.WOW_PROJECT_ID) < QuestieCompat.WOW_PROJECT_BURNING_CRUSADE_CLASSIC then
		return
	end
	...
	if (expansionLevel or QuestieCompat.WOW_PROJECT_ID) < QuestieCompat.WOW_PROJECT_WRATH_CLASSIC then
		return
	end
